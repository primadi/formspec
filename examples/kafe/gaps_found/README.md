...
| 22  | ✅ **Diperbaiki 2026-09-14** — `indexes:` (root **maupun** `persist`) kini dihormati dan field `relation` dapat kolom turunan; sebelumnya: `indexes:` tidak menghasilkan index apa pun; field `relation` tidak bisa diindeks → **unique komposit tidak bisa dinyatakan** — ✅ **ada jalan keluar: `kind: Migration`** (lihat #35/#36) | **HIGH**                          | ✅ Terverifikasi                                                                 |
...
| 38  | Workflow tidak bisa mengawal transisi dengan **banyak state asal** (`from` string tunggal) → void bisa lolos approval tanpa gejala                                                                                                                                                                                                    | **HIGH**                          | ✅ Terverifikasi                                                                 |
