// ─── FormaExpr Evaluator ───
//
// Tree-walking evaluator for the FormaExpr AST.
...
export function evaluate(
  ...
  // Evaluate the last expression statement (FormaExpr is expression-oriented)
...
function evalIdentifier(node: Identifier, context: EvalContext): RuntimeValue {
  ...
  // In FormaExpr, accessing an undefined field/property is a normal operation
