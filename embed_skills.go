// Package formspec embeds AI skills distributed with the CLI binary.
// These skills are written to new projects by `formspec init` so that
// VS Code Copilot (and compatible agents) can assist with FormSpec app
...
// own subdirectory (e.g., ai_skills/formspec-kinds/SKILL.md).
//
