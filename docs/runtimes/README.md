...
| FormSpec Operator | Implementasi awal ada (`cmd/formspec-operator`: tiga reconciler, verifikasi ed25519, reporter) — endpoint reporting sisi `formspec-ctl` belum ada — lihat `03-formspec-operator.md` §7                                                                                   |
