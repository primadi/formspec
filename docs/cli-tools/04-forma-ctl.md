...
Lihat [`02-forma-cli.md`](02-forma-cli.md) §11 untuk sisi Resource Plane.
...
```
forma-ctl freeze: not implemented yet — see docs/cli-tools/04-forma-ctl.md §5
```
...
| [`02-forma-cli.md`](02-forma-cli.md) §11 | Emergency command sisi Resource Plane (`forma freeze`, dst) |
