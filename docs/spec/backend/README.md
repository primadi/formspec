...
| [02-core-extended.md](02-core-extended.md) | Lifecycle, workflow (multi-approver), subscription, webhook, integrator, `kind: Api`, async action & job tracking, validation levels 4-6, hook spec, query builder, rate limiting, `ctx.secrets`, period closing & backdating, archiving & retention, audit trail bisnis |
