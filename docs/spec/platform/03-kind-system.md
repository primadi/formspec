...
| Visual — hirarkis, bukan flat | Instance `VisualSpecKind` (Page, Form, Table, Dashboard, Widget, Report, Wizard, Kanban, Timeline, Print, Theme) | `spec/frontend/02,05,06,07` |
