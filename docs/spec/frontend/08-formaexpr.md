...
**Garis bahasa:** ekspresi deklaratif = FormaExpr; kode frontend imperatif =
JS/TS lewat component contract
([`07-component-kinds.md`](07-component-kinds.md) §4). Starlark penuh di
browser ditolak — FormaExpr sengaja cuma subset ekspresi, bukan bahasa
lengkap.
...
**wajib** menolak konstruk di luar ekspresi ini saat `forma validate` — bukan
...
Identitas/permission caller **tidak** termasuk konteks evaluasi FormaExpr —
...
bukan lewat ekspresi ini. FormaExpr murni untuk kondisi *bisnis*, terpisah
...
membahas ini eksplisit — evaluasi FormaExpr cukup ringan by construction).
