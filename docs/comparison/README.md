...
| Dimension | [FormSpec](./formspec-vs-vercel.md) | [Spring Boot](./formspec-vs-springboot.md) | [Laravel](./formspec-vs-laravel.md) | [Frappe/ERPNext](./formspec-vs-frappe.md) | [PocketBase](./formspec-vs-pocketbase.md) | [Custom App](./formspec-vs-custom-app.md) | [Supabase](./formspec-vs-supabase.md) | [Budibase/NocoDB](./formspec-vs-budibase.md) |
|---|---|---|---|---|---|---|---|---|
...
| **Hosting** | Self-host + FormSpec Cloud | Self-host (any) | Self-host + Laravel Forge | Self-host + Frappe Cloud | Self-host (single binary) | Self-host (any) | Cloud-only | Self-host + Cloud |
