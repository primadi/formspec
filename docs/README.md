# Dokumentasi FormSpec

FormSpec adalah platform spec-driven: aplikasi dideklarasikan sebagai kumpulan spec
...
**App developer** (membangun aplikasi di atas FormSpec):
...
**Platform operator** (menjalankan FormSpec untuk banyak workspace):
...
- Seluruh isi ditulis present-tense — dokumen ini menjelaskan FormSpec sebagaimana
