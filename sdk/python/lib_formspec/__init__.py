"""lib-formspec-python — thin client SDK for formspec-sidecar.
...
No FormSpec business logic lives here — see docs/runtimes/04-formspec-sidecar.md §4.4
and sdk/README.md for the wire contract.
"""

from .app import ActionResult, App, Invocation
from .ctx import Ctx, CtxPrimitive, FormSpecError
