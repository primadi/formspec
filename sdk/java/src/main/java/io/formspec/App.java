...
/**
 * The lib-formspec-java listener: accepts {@code POST /invoke/{module}/{entity}/{action}}
...
public final class App implements AutoCloseable {
     ...
     * {@code FORMA_APP_SOCKET} (default {@code /var/run/formspec/app.sock}) and
     * {@code FORMA_SIDECAR_SOCKET} (default {@code /var/run/formspec/sidecar.sock}).
    ...
    public void run() {
        try {
            ...
            server.start();
            System.err.println("[lib-formspec-java] listening on http://localhost:" + port + "/");
        } catch (IOException e) {
    ...
    private static String detectSidecarEndpoint() {
        ...
        return env != null ? env : "unix:///var/run/formspec/sidecar.sock";
    }
}
