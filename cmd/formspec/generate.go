// Command `formspec generate` derives a typed TypeScript client from loaded
// entity manifests — the codegen half of `formspec.api` (docs/cli-tools/03-formspec-generate.md;
// docs/spec/backend/01-core-basic.md §8). The hand-written runtime half
// (auth, HTTP, error mapping) lives in the published package @formspec/client
...
// (docs/cli-tools/01-formspec-cli.md §5) are speced but not built.
package main
...
func generateTypeScript(reg *entity.Registry) (string, error) {
	...
	b.WriteString("// Code generated by `formspec generate`. DO NOT EDIT.\n")
	b.WriteString("//\n")
	b.WriteString("// Regenerate with: formspec generate --spec <dir> --out <this file>\n")
	b.WriteString("// Runtime (auth, HTTP, error mapping) lives in @formspec/client — this file only\n")
	b.WriteString("// adds types and a thin typed wrapper per entity (docs/cli-tools/03-formspec-generate.md).\n\n")
	b.WriteString("import { FormaClient, FormaRecord, ListOptions, ListResult } from \"@formspec/client\";\n\n")
