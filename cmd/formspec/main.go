...
func usage() {
	...
	fmt.Fprintf(os.Stderr, "  summary             Inspect/rebuild summary projections (list/rebuild)\n")
	...
	fmt.Fprintf(os.Stderr, "  upgrade             Self-update the binary from GitHub Releases\n")
